 ...
 * <p>
 * It's an specialization of {@link ProviderException} thrown to indicate that the system does not
 * have enough resources to complete the requested operation.
 * <p>
 ...
 * @since 0.1.0
 */
public class NotEnoughResourceException extends ProviderException
{
